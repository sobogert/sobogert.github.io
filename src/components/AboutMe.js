...
export function AboutMe({ selectedTheme }) {
    return (
            ...
            <div className="center-container">
                {
                    selectedTheme === 2 ?
                        ...
                        :
                    <p className="about-me-paragraph"> I'm currently working on the GCS II
                        (GPS) Program at Lockheed Martin as a Software Engineer, where I am leading design and frontend
                        development of multiple projects. Before that, I studied Computer Science
