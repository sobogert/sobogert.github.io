...
import boogieLogo from '../assets/svgs/boogie.svg';

export function NavBar({ selectedTheme }) {
                    ...
                    <div onClick={openMenu} className={"hamburger-menu"}>
                        {
                            <svg className={"nav-icon"} xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 28 28" fill="none">
                                <path d="M3.50008 5.83337C3.07933 5.82742 2.68797 6.04848 2.47586 6.41189C2.26374
                                     6.77532 2.26374 7.22479 2.47586 7.58821C2.68797 7.95163 3.07933 8.17268 3.50008
                                     8.16673H24.5005C24.9212 8.17268 25.3126 7.95162 25.5247 7.58821C25.7368 7.22478
                                     25.7368 6.77531 25.5247 6.41189C25.3126 6.04847 24.9212 5.82742 24.5005
                                     5.83337H3.50008ZM3.50008 12.8335C3.07933 12.8275 2.68797 13.0486 2.47586
                                     13.412C2.26374 13.7754 2.26374 14.2249 2.47586 14.5883C2.68797 14.9518 3.07933
                                     15.1728 3.50008 15.1669H24.5005C24.9212 15.1728 25.3126 14.9517 25.5247
                                     14.5883C25.7368 14.2249 25.7368 13.7754 25.5247 13.412C25.3126 13.0486 24.9212
                                      12.8275 24.5005 12.8335H3.50008ZM3.50008 19.8336C3.07933 19.8277 2.68797 20.0487
                                      2.47586 20.4121C2.26374 20.7756 2.26374 21.225 2.47586 21.5885C2.68797 21.9519
                                       3.07933 22.1729 3.50008 22.167H24.5005C24.9212 22.1729 25.3126 21.9519 25.5247
                                       21.5885C25.7368 21.225 25.7368 20.7756 25.5247 20.4121C25.3126 20.0487 24.9212
                                       19.8277 24.5005 19.8336H3.50008Z" fill="#252012"/>
                            </svg>
                            // selectedTheme === 2 ?
                            //     <svg className={"nav-icon"} xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 28 28" fill="none">
                                ...
                                <div id={"_menuExit"} onClick={closeMenu}>
                                    {
                                        <svg className={"nav-icon"} width="28" height="28" viewBox="0 0 28 28" fill="none">
                                            <path d="M5.822 4.65527C5.34725 4.6554 4.9199 4.94316 4.74126
                                            5.38302C4.56262 5.82287 4.66829 6.32711 5.00851 6.65824L12.3504
                                            14.0002L5.00851 21.3421C4.70373 21.6347 4.58096 22.0693 4.68755
                                            22.4781C4.79414 22.887 5.11342 23.2062 5.52228 23.3128C5.93113 23.4194
                                            6.36566 23.2966 6.65829 22.9919L14.0002 15.6499L21.3421 22.9919C21.6348
                                            23.2967 22.0693 23.4194 22.4782 23.3128C22.887 23.2063 23.2063 22.887
                                            23.3129 22.4781C23.4195 22.0693 23.2967 21.6347 22.9919 21.3421L15.65
                                            14.0002L22.9919 6.65825C23.337 6.32284 23.4407 5.80999 23.2532
                                            5.36683C23.0656 4.92367 22.6252 4.64111 22.1442 4.6553C21.8411 4.66433
                                            21.5534 4.791 21.3421 5.00849L14.0002 12.3504L6.65828 5.00849C6.43863
                                            4.7827 6.137 4.65528 5.822 4.65527Z" fill="#252012"/>
                                        </svg>
                        ...
                        <ul className="nav-list">
                            {
                                selectedTheme === 1 ?
                                    <li>
                                        <a className={"boogie"} href={"https://sophiabogert.com"}>
                                            <img alt={"Boogie my cat!"} src={boogieLogo}
                                            height={"48"} width={"46"}/>
                                        </a>
                                    </li>
                                    : selectedTheme === 2 ?
                            ...
                            <div className={"nav-list_cluster"}>
                                <li><a onClick={closeMenu} className={"nav-about"} href={"#aboutMe"}>About Me</a></li>
                                ...
                                <li><a onClick={closeMenu} className="nav-contact" href={"#contact"}>Contact</a></li>
