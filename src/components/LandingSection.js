            ...
            }
            {
                selectedTheme === 1 ?
                    <div className={"professional-landing"}>
                        <img alt={"Sophia Bogert in California!"} src={landingPageSvg}
                            height={"200px"} width={"196px"}/>
                        <h1 className={"name-bar"}>Hi, I'm Sophia Bogert!</h1>
                        <p className={"subtitle"}>I’m a software engineer focused on
                            designing and developing engaging user experiences</p>
                    </div>
               : selectedTheme === 2 ?
                    <div>
